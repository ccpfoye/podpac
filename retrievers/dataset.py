"""
From: https://github.com/huggingface/transformers/blob/main/examples/research_projects/rag-end2end-retriever/use_own_knowledge_dataset.py
"""
...
class RagExampleArguments:
    csv_path: str = field(
        default="/home/cfoye/Personal/podpac/retrievers/output_csv_file.csv",
    ...
    output_dir: Optional[str] = field(
        default="/home/cfoye/Personal/podpac/retrievers",
